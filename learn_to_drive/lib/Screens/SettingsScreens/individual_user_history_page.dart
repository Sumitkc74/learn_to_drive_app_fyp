                        ...
                        ListTile(
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              Text('${'correct-option'.tr} : ${individualUserHistory['correct_options']![index].tr}', style: const TextStyle(fontSize: 16)),
                              Text('${'selected-option'.tr} : ${individualUserHistory['selected_options']![index].tr}', style: const TextStyle(fontSize: 16)),
                            ],
                          ),
                        ),
                      ],
